...
public final class RequestMappingInfo implements RequestCondition<RequestMappingInfo> {
	...
	private static class DefaultBuilder implements Builder {
		...
		// ResultMapping注解paths参数
		private String[] paths = new String[0];
		// ResultMapping注解methods参数
		private RequestMethod[] methods = new RequestMethod[0];
		// ResultMapping注解params参数
		private String[] params = new String[0];
		// ResultMapping注解headers参数
		private String[] headers = new String[0];
		// ResultMapping注解consumes参数
		private String[] consumes = new String[0];
		// ResultMapping注解produces参数
		...
		public RequestMappingInfo build() {
			...
			// PatternsRequestCondition对象，该对象的patterns属性保存了方法注解的路径值如 /app
