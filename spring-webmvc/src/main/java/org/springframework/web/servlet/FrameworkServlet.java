...
public abstract class FrameworkServlet extends HttpServletBean implements ApplicationContextAware {
	...
	@Nullable // 在web.xml中配置
	private String contextInitializerClasses;

	/** Should we publish the context as a ServletContext attribute? */
	// 是否部署在ServletContext上
	 ...
	 */
	// 创建FrameworkServlet对象并初始化webApplicationContext属性值
	 ...
	 */
	// 获取namespace,默认为ServletName-servlet
	 ...
	 */
	@Nullable// 获取contextConfigLocation路径
	 ...
	 */
	@SuppressWarnings("unchecked") // 设置contextInitializers属性值
	 ...
	 */
	// 设置contextInitializerClasses属性值
	 ...
	 * @since 4.0
	 */
	@Override// 设置webApplicationContext属性值
	...
	protected final void initServletBean() throws ServletException {
		...
		// 抛出ServletException|RuntimeException异常
	...
	protected WebApplicationContext createWebApplicationContext(@Nullable ApplicationContext parent) {
		...
		// 判断contextClass是否继承ConfigurableWebApplicationContext类
		if (!ConfigurableWebApplicationContext.class.isAssignableFrom(contextClass)) {
			// 抛出ApplicationContextException异常
			throw new ApplicationContextException(
					"Fatal initialization error in servlet with name '" + getServletName() +
					"': custom WebApplicationContext class [" + contextClass.getName() +
					"] is not of type ConfigurableWebApplicationContext");
		}
		// 创建ApplicationContextException实例对象
	...
	protected void configureAndRefreshWebApplicationContext(ConfigurableWebApplicationContext wac) {
		...
		// 初始化ApplicationContextInitializer配置并调用initialize方法
	...
	protected void applyInitializers(ConfigurableApplicationContext wac) {
		...
		if (globalClassNames != null) {
			for (String className : StringUtils.tokenizeToStringArray(globalClassNames, INIT_PARAM_DELIMITERS)) {
				// 设置contextInitializers属性
				this.contextInitializers.add(loadInitializer(className, wac));
			}
		}

		// 当contextInitializerClasses不为空时
	...
	private ApplicationContextInitializer<ConfigurableApplicationContext> loadInitializer(
		...
		try {
			...
			// 返回ApplicationContextInitializer<ConfigurableApplicationContext>对象
	 ...
	 * @see #getServletName
	 */
	// 获取FrameworkServlet.CONTEXT.+ServletName
	 ...
	 */
	@Nullable // 获取WebApplicationContext对象
