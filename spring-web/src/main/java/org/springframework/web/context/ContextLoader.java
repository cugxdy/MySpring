...
public class ContextLoader {
	 ...
	 */
	// 类加载器与WebApplicationContext对应关系,表明类加载器加载WebApplicationContext
	...
	// 预处理ApplicationContextInitializer实例集合
	...
	public WebApplicationContext initWebApplicationContext(ServletContext servletContext) {
		// 当root上下文不为null,抛出IllegalStateException异常
		...
		try {
			...
			// 当为ConfigurableWebApplicationContext类型时
			...
			// 在ServletContext中设置WebApplicationContext.ROOT = this.context
	...
	protected WebApplicationContext createWebApplicationContext(ServletContext sc) {
		...
		// 当contextClass并非继承ConfigurableWebApplicationContext类时,抛出异常
	...
	protected Class<?> determineContextClass(ServletContext servletContext) {
		// 获取ServletContext的contextClass属性值
		String contextClassName = servletContext.getInitParameter(CONTEXT_CLASS_PARAM);
		if (contextClassName != null) {
			try {
				// 获取contextClass属性值对应的Class对象
			...
			// 获取WebApplicationContext属性值
			contextClassName = defaultStrategies.getProperty(WebApplicationContext.class.getName());
			try {
				// 获取contextClassName属性值对应的Class对象
	...
	protected void customizeContext(ServletContext sc, ConfigurableWebApplicationContext wac) {
		...
		// 遍历initializerClasses
		for (Class<ApplicationContextInitializer<ConfigurableApplicationContext>> initializerClass : initializerClasses) {
			Class<?> initializerContextClass =
					GenericTypeResolver.resolveTypeArgument(initializerClass, ApplicationContextInitializer.class);
			// 当initializerContextClass不为空时并且不能转换时,抛出ApplicationContextException异常
	...
	protected List<Class<ApplicationContextInitializer<ConfigurableApplicationContext>>>
		...
		// 获取contextInitializerClasses属性值
