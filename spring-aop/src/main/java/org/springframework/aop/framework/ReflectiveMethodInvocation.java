...
public class ReflectiveMethodInvocation implements ProxyMethodInvocation, Cloneable {
	...
	protected ReflectiveMethodInvocation(
		...
		this.targetClass = targetClass; // 目标Class对象
		this.method = BridgeMethodResolver.findBridgedMethod(method); // 是否存在桥接方法
		// 将参数更改下
	...
	@Override// 获取arguments对象
	public final Object[] getArguments() {
		return this.arguments;
	}

	@Override// 设置arguments对象
	...
	public Object proceed() throws Throwable {
		...
		// 获取MethodInterceptor对象
		Object interceptorOrInterceptionAdvice =
				this.interceptorsAndDynamicMethodMatchers.get(++this.currentInterceptorIndex);
		// 当为InterceptorAndDynamicMethodMatcher类型时,即系统处于运行中
